...
create.glmm.data<-function(data, w, sampler, count.cov, count.cov.fac) {
    ...
    colnames(glmm.data)<-c("smp.vis","smp.id","gr.id","vis.id","detections","individuals","line.length",count.cov)
