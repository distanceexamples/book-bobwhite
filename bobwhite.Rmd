...
For completing this case study, we need to download the zip file [CoveyCaseStudy.zip](CaseStudyBOWH.zip) and extract these into a designated folder on our personal computers. Source the functions necessary for the case study, by running the following R code. 
